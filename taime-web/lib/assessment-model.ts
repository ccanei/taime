...
export const QUESTIONS: AssessmentQuestion[] = [
  ...
  q('cloud_1', 'cloud',
    'Onde roda a maior parte das suas cargas hoje?',
    'Where do most of your workloads run today?',
    [
      ['Servidores próprios / on-premise, com pouca elasticidade', 'Own servers / on-premise, with little elasticity'],
      ['Começando na nuvem, mas o essencial ainda on-premise (híbrido por inércia)', 'Starting on cloud, but the core still on-premise (hybrid by inertia)'],
      ['Majoritariamente em nuvem, com alguma automação de provisionamento', 'Mostly on cloud, with some provisioning automation'],
      ['Nuvem com infraestrutura como código, escala elástica e múltiplos ambientes', 'Cloud with infrastructure as code, elastic scale and multiple environments'],
    ]),
  q('cloud_2', 'cloud',
  ...
  q('ai_3', 'ai',
    'Como vocês decidem o que vale automatizar ou aplicar IA?',
    'How do you decide what is worth automating or applying AI to?',
    [
      ['Por intuição ou por pedido pontual de alguém', 'By intuition or a one-off request from someone'],
      ['Caso a caso, sem critério formal', 'Case by case, with no formal criterion'],
      ['Com critério de valor e viabilidade, priorizado', 'With a value and feasibility criterion, prioritized'],
      ['Portfólio priorizado por retorno, com pilotos e critério de saída', 'A portfolio prioritized by return, with pilots and an exit criterion'],
    ]),
  q('ai_4', 'ai',
  ...
  q('security_4', 'security',
    'Compliance e requisitos regulatórios, hoje, são...',
    'Compliance and regulatory requirements, today, are...',
    [
      ['Tratados quando um cliente ou auditor cobra', 'Handled when a client or auditor asks'],
      ['Atendidos de forma reativa, projeto a projeto', 'Met reactively, project by project'],
      ['Mapeados, com responsáveis definidos', 'Mapped, with defined owners'],
      ['Parte do processo, monitorados e demonstráveis a qualquer momento', 'Part of the process, monitored and demonstrable at any time'],
    ]),
