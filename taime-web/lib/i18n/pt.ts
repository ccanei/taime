    ...
    plans: [
      {
        ...
        features: ['2 relatórios completos por mês', 'Histórico de 1 ano', 'Score e framework completos'],
      ...
      },
      {
        ...
        features: ['Relatório completo com todas as trends', 'Framework TYPE→ACT→IMPACT→MOVE→EXIT', 'Score dimensions detalhado', 'Histórico completo de 3 anos', 'Preview de todo o histórico anterior', 'Executive Advisor (uso limitado)'],
