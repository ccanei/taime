...
export const en: Translations = {
    ...
    plans: [
      {
        ...
        features: ['2 full reports per month', '1 year of history', 'Full score and framework'],
      ...
      },
      {
        ...
        features: ['Full report with all trends', 'Framework TYPE→ACT→IMPACT→MOVE→EXIT', 'Detailed score dimensions', '3 years of full history', 'Preview of the full prior archive', 'Executive Advisor (limited use)'],
  ...
  planos: {
    ...
    finalCtaBody:  'Join the waitlist and secure access with special launch conditions.',
    finalCtaBtn:   'Request access →',
  },
