  ...
  home: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['Full report with all trends', 'Framework TYPE→ACT→IMPACT→MOVE→EXIT', 'Detailed score dimensions', '1-year history'],
      ...
      },
      {
        ...
        features: ['Everything in Essential', 'Biweekly reports', 'Full archive since 2000'],
