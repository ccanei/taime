...
export const en: Translations = {
  ...
  home: {
    ...
    themesCards: {
      ...
      since:    'since',
      items: [
        { name: 'AI governance',                             start: 2018 },
        { name: 'Autonomous AI agents',                      start: 2023 },
        { name: 'AI and cybersecurity: the arms race',       start: 2016 },
        { name: 'Commercial quantum computing',              start: 2018 },
        { name: 'Semiconductor sovereignty and geopolitics', start: 2019 },
        { name: 'AI in financial services',                  start: 2018 },
        { name: 'Privacy and global data fragmentation',     start: 2015 },
        { name: 'Energy and sustainable infrastructure',     start: 2016 },
      ],
    },
    trajectory: {
    ...
    ask: {
      ...
      limitBody:    'Create your free account to continue: 10 more questions on Free, 250 on Essential.',
      ...
      cards: [
        { iconKey: 'trajectory', title: 'Agentic AI governance',   description: 'How it evolved and what changes for you', prompt: 'How has agentic AI governance evolved and what changes for my company?' },
        { iconKey: 'focus',      title: 'Post-quantum readiness',  description: 'Is your company behind?',                prompt: 'Is my company behind on post-quantum readiness?' },
        { iconKey: 'map',        title: 'Data sovereignty',        description: 'Impact on cloud architecture',           prompt: 'What does data sovereignty change in my cloud architecture decision?' },
        { iconKey: 'question',   title: 'What is TAIME?',          description: 'How the platform works',                 prompt: 'What is TAIME?' },
      ],
    ...
    plans: [
      {
        ...
        features: ['Full archive since 2015', '2 complete reports per month', 'Executive Advisor: 10 welcome messages', 'Full score and framework'],
        cta: 'Create free account →', href: '/login', highlight: false,
      },
      {
        name: 'Essential', price: 'US$ 38/mo', priceOriginal: 'US$ 74/mo',
        priceNote: 'Launch condition. Price locked forever.',
        freeNote:  'Instant activation on signup. Free for a limited time.',
        badge: null,
      ...
      },
      {
        ...
        features: ["Multiple seats with shared strategic memory", "Executive Advisor with your company's context", 'Microsoft Teams integration', 'On-demand reports and artifacts', 'Corporate invoicing'],
        cta: 'Contact us', href: '/login', highlight: false,
      },
    ],
  ...
  faq: {
    items: [
      ...
      { q: 'Is the full archive already available?', a: 'Yes. The full archive, since 2015, is available on every plan, and keeps expanding with each new publication. On Free you open 2 complete reports per month; on Essential access is unlimited.' },
  ...
  planos: {
    ...
    planCards: [
      { name: 'Free',       price: 'Free',       priceOriginal: null,        priceNote: null,                                        freeNote: null,                                                desc: 'Start deciding with real data',   badge: null, highlight: false, cta: 'Create account →'    },
      { name: 'Essential',  price: 'US$ 38/mo',  priceOriginal: 'US$ 74/mo', priceNote: 'Launch condition. Price locked forever.',    freeNote: 'Instant activation on signup. Free for a limited time.', desc: 'For the executive who decides.',   badge: null, highlight: true,  cta: 'Start with Essential →' },
      { name: 'Strategic',  price: 'Custom',     priceOriginal: null,        priceNote: null,                                        freeNote: null,                                                desc: 'For organizations.',              badge: null, highlight: false, cta: 'Contact us'          },
    ],
    planFeatures: [
      ...
      { label: 'Archive access',                  free: 'Since 2015',  essential: 'Since 2015',        strategic: 'Since 2015' },
      { label: 'Complete reports',                free: '2 per month', essential: 'Unlimited',         strategic: 'Unlimited'  },
      { label: 'Executive Advisor',               free: '10 messages', essential: '250 messages/month', strategic: 'Unlimited' },
    ],
  ...
  advisorOnboarding: {
    headerTitle: 'Complete my profile',
    headerDesc:  'Optional. The more context, the sharper the guidance. You can skip and talk directly.',
    ...
    s1Desc:      'Organizational context to personalize the analysis.',
    companyLabel:'Company name',
    companyPh:   'E.g.: Acme Corp',
    sectorLabel: 'Sector',
    sectorPh:    'Select the sector',
    sizeLabel:   'Size',
    s2Title:     'Current infrastructure',
    s2Desc:      'What does your technology environment look like today?',
    infraLabel:  'Describe your current technology infrastructure',
    infraPh:     'E.g.: We use Azure for cloud, SQL Server on-premise for legacy systems, Salesforce for CRM...',
    techLabel:   'Technologies in use',
    techHint:    '(check all that apply)',
    s3Title:     'Strategic objective',
    s3Desc:      'What is the main focus for the next 12 to 18 months?',
    objLabel:    'Describe your strategic objective',
    objPh:       'E.g.: Modernize the data infrastructure and implement AI capabilities to optimize operations...',
    suggestions: 'Suggestions:',
    s4Title:     'Technology maturity',
    s4Desc:      'How do you rate your company current level?',
    sectors: {
      'Tecnologia': 'Technology', 'Financeiro': 'Financial', 'Saúde': 'Healthcare', 'Varejo': 'Retail',
      'Indústria': 'Industry', 'Serviços': 'Services', 'Educação': 'Education', 'Outro': 'Other',
    },
    sizes: {
      '1-10 funcionários': '1-10 employees', '11-50 funcionários': '11-50 employees',
      '51-200 funcionários': '51-200 employees', '201-1000 funcionários': '201-1000 employees',
      '1000+ funcionários': '1000+ employees',
    },
    infra: {
      'On-premise': 'On-premise', 'Cloud pública': 'Public cloud', 'Cloud híbrida': 'Hybrid cloud',
      'SaaS': 'SaaS', 'Legacy systems': 'Legacy systems', 'IA em uso': 'AI in use',
    },
    maturity: {
      'inicial':       { label: 'Initial',      desc: 'Still exploring the technology possibilities' },
      'intermediário': { label: 'Intermediate', desc: 'Some projects underway, foundation established' },
      'avançado':      { label: 'Advanced',     desc: 'Mature digital operations and specialized teams' },
    },
    objectiveChips: [
      'Migrate to cloud', 'Implement agentic AI', 'Modernize infrastructure',
      'Reduce operational costs', 'Expand to new markets',
    ],
  },
} as const
