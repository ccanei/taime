              ...
              <div key={p.id} className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="min-w-0">
                    ...
                    <h3 className="text-sm font-semibold text-zinc-900 leading-snug line-clamp-2">{p.trend_title ?? '(sem trend)'}</h3>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                      onClick={() => { if (confirm('Excluir este rascunho?')) act(p.id, 'delete') }}
                      disabled={busy === p.id}
