            ...
            {[
              ...
              <div key={title}
                   className={`rounded-xl border p-6 flex flex-col transition-all ${
                     cta
                       ? 'bg-taime-50/40 border-taime-200 ring-1 ring-taime-100 hover:border-taime-300 hover:shadow-md'
                       : 'bg-white border-zinc-200 hover:border-taime-200 hover:shadow-sm'
                   }`}>
                ...
                {cta && (
                  <Link href={cta.href}
                        className="mt-4 inline-flex items-center gap-1 text-sm font-semibold
                                   text-taime-700 hover:text-taime-800 hover:gap-2 transition-all">
